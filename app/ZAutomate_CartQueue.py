...
class CartQueue():
    ...
    ###UIUpdate - Function Pointer for callbacks to update UI with CartQuery info
    UIUpdate = None
    ...
    def Extend(self, cartArr):
        ...
        print self.timeStamp() + " :=: CartQuery :: Extend :: Generating start times"
        self.GenStartTimes(lenOld)    
    
    
    ###YATES_COMMENT: Dequeue's the 0th entry from the CartQuery::Arr array.
...
##            self.Extend( DBInterface().Playlist_Next_Enqueue() )
    ...
    def InsertAllCarts(self):
        ...
        ###YATES_COMMENT: What/Where is AUTOMATION_CARTS?
        ###YATES_ANSWER : Comes from ZAutomate_Config.py.  Array structure of tuples.
        ### AUTOMATION_CARTS = [('StationID+PSA', 15, 300), ('StationID+Underwriting', 30, 300), 
        ###                            ('StationID+PSA', 45, 300), ('StationID', 60, 300)]
    ...
    def InsertCart(self, cartType, minuteBreak, maxOffset, firstRun=True):
